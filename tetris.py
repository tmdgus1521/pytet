...
class Tetris():
    ...
    def accept(self, key): # To be implemented!!
        ...
        if key == 'a': # move left
           ...
           self.idxBlockDegree = (self.idxBlockDegree + 1) % Tetris.nBlockDegrees #이전 배열을 회전한 다음 인덱스로 이동
        ...
        if self.tempBlk.anyGreaterThan(1):
            if key == 'a': # undo: move right
                ...
                self.idxBlockDegree = (self.idxBlockDegree - 1) % Tetris.nBlockDegrees #회전하기 전으로 배열 인덱스 이동
